...
Door deel te nemen aan deze community, stemt u ermee in zich niet in te laten met gedrag dat in strijd is met deze waarden tijdens een door Bioconductor gesponsord evenement (persoonlijk of virtueel, inclusief maar niet beperkt tot lezingen, workshops, postersessies, sociale activiteiten), elektronische communicatiekanalen ( inclusief maar niet beperkt tot de "community-bioc" [Slack](https://slack.bioconductor.org), de ondersteuningssite, online forums, de beoordelingssite voor packages en communicatie via sociale media), of packages (commits inbegrepen). Verder eisen we dat alle deelnemers identificeerbare accounts hebben op de online fora van Bioconductor. Accounts die zich hier niet aan houden na verzoek tot de-anonimisering kunnen worden verwijderd.
