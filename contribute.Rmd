...
- Edit the new file as needed, following these rules:
  ...
  + In the title, the language name should be written in the language itself, not necessarily English.
...
- Update the file `about.Rmd` as needed, following these rules:
  + Add a level 4 section header with the flag of the country, name of the language, and name of the country.
...
- Open an issue or a pull request, tagging the maintainer of the language (listed in the file `about.Rmd`).
